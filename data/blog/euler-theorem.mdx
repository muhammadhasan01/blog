...
draft: false
summary: Blog about Euler Totient Function, it's definition, proof, and use cases
images: []
---

I am long fascinated by Euler totient function, and so I wanted to write it here and share about it. Let's discuss the definition, use cases, and some proofs.
...
Here are C++ implementations for computing euler totient function:
