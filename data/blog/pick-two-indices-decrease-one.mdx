---
title: Pick Two Indices And Decrease Both of Them
date: '2024-07-10'
tags: ['programming', 'mathematics']
draft: false
summary: 'An interesting problem that I have been pondering on for a while'
---
...
To make it more simple, we can claim that the maximum integer in all of $a_i$ must be less or equal to all the other integers.
